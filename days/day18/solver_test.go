...
func TestSolvePart1(t *testing.T) {
	testCases := []struct {
		...
		{"Test 1", *config.NewTestInput(1), nil, "10"},
		{"Test 2", *config.NewTestInput(2), nil, "64"},
		{"Real", *config.NewRealInput(), nil, "3454"},
	}
...
func TestSolvePart2(t *testing.T) {
	testCases := []struct {
		...
		{"Test 1", *config.NewTestInput(1), nil, "10"},
		{"Test 2", *config.NewTestInput(2), nil, "58"},
		{"Real", *config.NewRealInput(), nil, "2014"},
	}
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			solver := &Solver{}
