...
func TestSolvePart1(t *testing.T) {
	testCases := []struct {
		...
		{"Test 1", *config.NewTestInput(1), nil, "95437"},
		{"Real", *config.NewRealInput(), nil, "1667443"},
	}
...
func TestSolvePart2(t *testing.T) {
	testCases := []struct {
		...
		{"Test 1", *config.NewTestInput(1), nil, "24933642"},
		{"Real", *config.NewRealInput(), nil, "8998590"},
	}
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			solver := &Solver{}
