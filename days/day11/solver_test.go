...
func TestSolvePart1(t *testing.T) {
	testCases := []struct {
		...
		{"Test 1", *config.NewTestInput(1), nil, "10605"},
		{"Real", *config.NewRealInput(), nil, "113232"},
	}
...
func TestSolvePart2(t *testing.T) {
	testCases := []struct {
		...
		{"Test 1", *config.NewTestInput(1), nil, "2713310158"},
		{"Real", *config.NewRealInput(), nil, "29703395016"},
	}
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			solver := &Solver{}
